...
jQuery(document).ready(function($) {
    ...
    if ($(".plupload-upload-uic").exists()) {
        ...
        $(".plupload-upload-uic").each(function() {
            ...
            pconfig = JSON.parse(JSON.stringify(jpro_cars_plupload_config));
            ...
            var uploader = new plupload.Uploader({
                browse_button : pconfig["browse_button"],
                container : pconfig["container"],
                url : pconfig["url"],
                file_data_name : pconfig["file_data_name"],
                multi_selection : pconfig["multi_selection"],
                resize : pconfig["resize"]
            });
            ...
            uploader.init(console.log("[uploader.init]"));
 
            // Added: 12 September 2018
            uploader.bind('BeforeUpload', function(up, file) {
                console.log("[BeforeUpload]");
                up.settings.multipart_params = pconfig["multipart_params"];
            });
